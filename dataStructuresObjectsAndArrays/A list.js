...
they share the structure that makes up their last three elements. The original list 
...
function arrayToList(arr) {
  ...
  for (let i = arr.length - 1; i >= 0; i--) {
    objFromList.value = arr[i];
    objFromList.rest = list;
...
function prepend(el, functionList) {
  let objList = {};
